...
define('MODULE_PAYMENT_CARDSTREAM_DIRECT_URL','https://payment.card-saver.co.uk/direct/');
define('MODULE_PAYMENT_CARDSTREAM_MODAL_URL','https://payment.card-saver.co.uk/hosted/modal');
define('MODULE_PAYMENT_CARDSTREAM_FORM_URL', 'https://payment.card-saver.co.uk/hosted/');

define('MODULE_PAYMENT_CARDSTREAM_ADMIN_TITLE', 'Card Saver LTD');
